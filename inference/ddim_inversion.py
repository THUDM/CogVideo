...
def get_args() -> DDIMInversionArguments:
    ...
    parser.add_argument("--model-path", type=str, required=True, help="Path of the pretrained model")
    parser.add_argument("--prompt", type=str, required=True, help="Prompt for the direct sample procedure")
    parser.add_argument("--video-path", type=str, required=True, help="Path of the video for inversion")
    parser.add_argument("--output-path", type=str, default="output", help="Path of the output videos")
    ...
    parser.add_argument("--skip-frames-start", type=int, default=0, help="Number of skipped frames from the start")
    parser.add_argument("--skip-frames-end", type=int, default=0, help="Number of skipped frames from the end")
    parser.add_argument("--frame-sample-step", type=int, default=None, help="Temporal stride of the sampled frames")
    parser.add_argument("--max-num-frames", type=int, default=81, help="Max number of sampled frames")
